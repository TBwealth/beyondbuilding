...
@Component({
  selector: 'app-newinternalaccount',
  templateUrl: './newinternalaccount.component.html',
  styleUrls: ['./newinternalaccount.component.css']
})
export class NewinternalaccountComponent implements OnInit {
  ninvform: FormGroup;
  form: FormGroup;
  newInvErr: string;
