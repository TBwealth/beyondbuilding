...
@Component({
  selector: 'app-modifyterminal',
  templateUrl: './modifyterminal.component.html',
  styleUrls: ['./modifyterminal.component.css']
})
export class ModifyterminalComponent implements OnInit {
